  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <button 
        onClick={PrevSlace}
        className='absolute left-0 top-1/2 -translate-y-1/2 border border-gray-500 bg-gray-800/60 text-white p-2 rounded-full'><FaAngleLeft/></button>

        <button 
        onClick={NextSlice}
        className='absolute right-0 top-1/2 -translate-y-1/2 border border-gray-500 bg-gray-800/60 text-white p-2 rounded-full'><FaAngleRight/></button>
      </div>
    </motion.div>
  );
}
