...
import { AiOutlineTool, AiOutlineUser, AiOutlineShop } from "react-icons/ai"
...
function EditRoleandPhone() {
        ...
        const handleSubmit = async (e:React.FormEvent) => {
            e.preventDefault()
            if(!role || !phone){
                alert("please select the role and enter the number")
                return;
            }
            setLoading(true)
            try {
  ...
  return (
    <div className="min-h-creen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white p-6">
      <AnimatePresence>
      <motion.div
