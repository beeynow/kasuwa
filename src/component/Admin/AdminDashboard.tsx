...
import { FaCheckCircle, FaShoppingBag, FaStore } from "react-icons/fa";
...
function AdminDashboard() {
  ...
  const menu = [
    ...
    { id: "orders", label: "Users Orders", icon: <FaShoppingBag size={22} /> },
    {
      id: "vendor-approval",
  ...
  return (
    <div className="w-full  min-h-screen flex  bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      {/* Mobile Tab bar */}
      <div className="lg:hidden fixed top-15 left-0 w-full bg-black px-6 py-3 flex justify-between items-center border-b border-gray-700 x-50">
      ...
      <AnimatePresence>
        {openMenu && (
          <motion.div
            ...
            className="lg:hidden fixed top-0 left-0 w-60 h-full bg-gray-800 backdrop-blur-xl p-6 z-50 border-r border-gray-600"
          >
